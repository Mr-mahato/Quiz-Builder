    ...
    <div className="max-w-7xl mt-20 border-2 p-2 gap-2 rounded-md mx-auto flex justify-between">
      ...
      <div className="flex flex-1 flex-col gap-2">
        {Array.from({ length: categoryNumber }).map((_, index) => {
          return (
            <>
             <div className="grid grid-cols-3 border p-2 rounded-md flex-1">
        <div className="col-start-1 mt-4 col-span-2">
          ...
          <div className="grid grid-cols-3">
            <h1 className="self-center text-xl">Category</h1>
            <h1 className="text-center text-xl">Belongs to</h1>
          </div>
          {categories.length > 1 && (
            <div>
      ...
      <div className="flex flex-col justify-center bg-neutral-300 p-2 rounded-full h-5 w-5 items-center">
        <button
